...
export function _propsSpreader(incomingProps: any) {
  const flattenedDefaultProps: any = incomingProps;
  if ('bgColor' in incomingProps) {
    incomingProps['bg'] = incomingProps['bgColor'];
    delete incomingProps['bgColor'];
  }
 ...
 */
export function useLegacyPropsResolution(
  component: string,
  incomingProps: any,
  state?: IStateProps,
  config?: {
